...
interface CustomerBookCallProps {
  onViewCalls?: () => void;
}
...
export function CustomerBookCall({ onViewCalls }: CustomerBookCallProps) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      const notificationPayload = {
        ...
        actor_name: contactName.trim() || companyName.trim() || 'Customer Portal',
        data: {
          ...
          admin_notes: `Booked via Customer Portal. Ref: ${refId}`,
          requesting_engineer_name: 'Customer Portal',
        },
      };
