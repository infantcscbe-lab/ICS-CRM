      ...
      <div className="mb-4 flex flex-col sm:flex-row sm:items-center gap-2.5">
        ...
        <div className="relative w-full sm:w-auto" ref={dropdownRef}>
          <button
            ...
            className={`flex w-full sm:w-auto items-center justify-between sm:justify-start gap-2 rounded-xl border px-3.5 py-2 text-xs font-bold transition shadow-2xs ${
              dropdownOpen
          ...
          {/* Slide-Down Menu */}
          {dropdownOpen && (
            <div className="absolute left-0 right-0 sm:left-auto sm:right-0 z-30 mt-1.5 w-full sm:w-60 origin-top rounded-2xl border border-slate-200 bg-white p-1.5 shadow-xl transition-all animate-in fade-in slide-in-from-top-2 duration-150">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-x-2.5 gap-y-1 text-xs text-slate-500">
                    ...
                    <span className="inline-flex items-center gap-1 rounded bg-slate-100 px-1.5 py-0.5 text-[11px] font-medium text-slate-700">
                      👤 Assigned by:{' '}
                      <strong className="text-slate-900 truncate max-w-[120px]">
                    ...
                    {(() => {
                      ...
                      return (
                        ...
                        >
                          <Cpu className="h-3 w-3 text-blue-600 shrink-0" />
                          <span className="truncate max-w-[90px]">{targetId}</span>
                          <span className="font-sans text-[9px] uppercase opacity-85 shrink-0">
